                    ...
                    ? Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Expanded(flex: 4, child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
                          ...
                          _fieldCard(children: [
                            ...
                            _divider(),
                            _infoRow("平均游戏时长", _formatPlaytime(game), Icons.timer),
                          ]),
      ...
      actions: [
        if (_task.status == "failed")
          ...
          Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
            ...
            Align(alignment: Alignment.centerRight, child: FilledButton(onPressed: () => Navigator.pop(context), child: const Text("关闭"))),
          ]),
