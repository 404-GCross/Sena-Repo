...
class _SetupWizardScreenState extends State<SetupWizardScreen> {
  ...
  List<Widget> _buildStep2() => [
    ...
    Text("客户端下载游戏保存的位置", style: TextStyle(AppText.label, color: hintColor(context))),
    const SizedBox(height: 8),
    Row(children: [
  ...
  List<Widget> _buildStep3() => [
    ...
    const SizedBox(height: 8),
    Text("PC 端专属，可稍后在设置中配置", style: TextStyle(AppText.label, color: hintColor(context))),
  ];
  ...
  List<Widget> _buildStep4() => [
    Text("选择刮削源，勾选后可用", style: TextStyle(AppText.label, color: hintColor(context))),
    const SizedBox(height: 8),
    ...
    Text("刮削源走代理访问，如 http://127.0.0.1:7890", style: TextStyle(AppText.label, color: hintColor(context))),
    const SizedBox(height: 8),
    TextField(
    ...
    const SizedBox(height: 8),
    Text("可稍后在设置中修改", style: TextStyle(AppText.label, color: hintColor(context))),
  ];
}
