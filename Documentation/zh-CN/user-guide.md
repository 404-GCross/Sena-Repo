...
> **⚠️ 注意：** Sena-Repo 面向内网和私有服务器场景设计，当前并未实现面向公网部署所需的 HTTPS / WAF / 速率限制等安全措施。**强烈建议仅在 VPN、Tailscale 或家庭内网环境中使用，不要直接暴露到公网。**
>
> 已部署到公网的用户请注意：任何人只要能访问端口即可浏览你的游戏库、查看服务器文件路径、注册账号。请自行做好防火墙规则或反向代理加固。
